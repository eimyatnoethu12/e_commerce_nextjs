...
export function SimpleRegistrationForm() {
    ...
    return (
        ...
        //     <h4 className="block font-sans mt-2 rounded-md p-2
        //      text-2xl font-semibold leading-snug tracking-normal bg-red-700 text-black antialiased">
        //         First, you need to register to order !
        //     </h4>
        //     <h5 className="mt-4 block font-sans font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
        //         Register
        //     </h5>
        ...
        //             type="button"
        //             data-ripple-light="true" onClick={handling}
        //         >
        //             Register
        //         </button>
